...
def modbus_crc(buf): # https://github.com/raphaelnunes67/MODBUS-CRC16
    crc = 0xFFFF
...
def get_profiles():
    ...
    try:
        ...
        for i in range(10):
            ...
            crc = modbus_crc(data_get_profile[0:5])
...
def change_profile(nr, vo_set, io_set, activate = False):
    """ Change one profile. """
    vendor_id = 0x2e3c
    product_id = 0xaf01
    data_get_profile = bytearray(64)
    ...
    try:
        ...
        if len(response) == 64 and response[0] == 0xFA and response[1] == 0x35 \
            ...
            if activate:
                ...
                #data_get_profile[5] = 0x01
            else:
                data_get_profile[4] = 0x40 + nr
                #data_get_profile[5] = 0x00
            ...
            crc = modbus_crc(data_get_profile[0:14])
...
def off():
    ...
    product_id = 0xaf01
    data_get_profile = bytearray(64)
    data_get_profile[0:5] = 0xfb, 0x35, 0x00, 0x01, 0x80
...
#answer = get_active_profile_info()
#print(answer)
#answer = change_profile(1,3.5,0.5,True)
#print(answer)
#answer = get_active_profile_info()
#print(answer)
#answer = get_basic_info()
...
print("change without activation")
answer = change_profile(0,1.3,2.5)
print("response is: ",answer)
answer = get_profiles()
print("response is: ",answer)
answer = get_active_profile_info()
